...
Bootstrap uses a 12-column wide grid system wrapped inside a container, which can be organized in any way you wish. 

By default all elements are set to full width: 12 columns wide.
...
The 'and up' means that unless you specify otherwise, when you apply 'md' to an element, it will apply to 'md' and 'lg'
Similarly, when you apply 'sm' to an element, it applies to 'sm', 'md' and 'lg' form factors
By default, xs is applied to all elements
...
These column options can be combined with rows to create any arrangement of boxes desired on the page
